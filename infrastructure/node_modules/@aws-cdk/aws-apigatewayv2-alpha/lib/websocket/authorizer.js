...
class WebSocketAuthorizer extends core_1.Resource {
    ...
    static fromWebSocketAuthorizerAttributes(scope, id, attrs) {
        try {
            jsiiDeprecationWarnings.print("@aws-cdk/aws-apigatewayv2-alpha.WebSocketAuthorizer#fromWebSocketAuthorizerAttributes", "");
    ...
    constructor(scope, id, props) {
        super(scope, id);
        try {
            jsiiDeprecationWarnings.print("@aws-cdk/aws-apigatewayv2-alpha.WebSocketAuthorizer", "");
...
WebSocketAuthorizer[_a] = { fqn: "@aws-cdk/aws-apigatewayv2-alpha.WebSocketAuthorizer", version: "2.114.1-alpha.0" };
/**
...
class WebSocketNoneAuthorizer {
    bind(_options) {
        try {
            jsiiDeprecationWarnings.print("@aws-cdk/aws-apigatewayv2-alpha.WebSocketNoneAuthorizer#bind", "");
